      ...
      />
        ...
        <div className="container mx-auto px-4 pt-[2.25rem] md:pt-[5rem]">
          <div className="inline-flex items-center justify-center">
            ...
            <div
              className={cn(
                "group rounded-full border border-black/5 bg-gray-50 px-6 py-2 text-sm text-white transition-all ease-in hover:cursor-pointer hover:bg-white dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800"
              )}
            >
              <AnimatedShinyText className="inline-flex items-center justify-center transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                <span>✨ SAGE University, Indore</span>
              </AnimatedShinyText>
            </div>
          </div>
              ...
              <div className="">
                <div className="flex sm:inline-flex flex-col sm:flex-row items-center md:gap-4">
                  <img
                    ...
                    className="h-8 mt-4"
                  />
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#303030]">
                ...
                <p className="text-md mt-2 md:mt-6 text-gray-600 md:text-lg leading-5 md:leading-relaxed px-4 md:text-center text-justify">
                  {/* <TextAnimate animation="blurIn" className="text-md mt-2 md:mt-6 text-gray-600 md:text-lg leading-5 md:leading-relaxed px-4 md:text-center text-justify"> */}
                    Google Developer Group (GDG) is a student-led community
                    backed by Google Developers aimed at empowering
                    undergraduate students from all disciplines to grow their
                    knowledge in technology, build solutions for their local
                    communities, and connect with other members from the Google
                    community.
                  {/* </TextAnimate> */}
                </p>
              </div>
